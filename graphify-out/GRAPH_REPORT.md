...
## Corpus Check
- 29 files · ~44,300 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 153 nodes · 162 edges · 14 communities (12 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59e6ee98`
...
1. `CONTENT.md — Site Content (single source of truth)` - 10 edges
2. `init()` - 9 edges
3. `scripts` - 6 edges
4. `allowScripts` - 6 edges
5. `DESIGN.md — PCB / Blueprint Aesthetic` - 6 edges
6. `Signature elements` - 6 edges
7. `Portofolio Astro` - 6 edges
8. `STYLE.md — Design Tokens & CSS Classes` - 6 edges
9. `ThreeScene()` - 5 edges
10. `include` - 4 edges
...
### Community 13 - "STYLE.md — Design Tokens & CSS Classes"
Cohesion: 0.33
...
## Knowledge Gaps
- **78 isolated node(s):** `name`, `type`, `version`, `node`, `dev` (+73 more)
